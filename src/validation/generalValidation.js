...
const GeneralValidation = {
  ...
  validateParameters(payload) {
    const schema = {
      ...
      cinemaIds: joi.number().integer().positive().label('Please a valid cinema'),
      genreIds: joi.number().integer().positive().label('Please a valid genre'),
      mediaIds: joi.number().integer().positive().label('Please a valid media'),
